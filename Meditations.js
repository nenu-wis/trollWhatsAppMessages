...
And what are we to make of anyone who cares about the applause of such people, who don&rsquo;t know where or who they are?
...
2.10 the ones committed out of desire are worse: Strictly speaking, this assessment is in conflict with Stoic doctrine, which holds that there are no degrees of wrongness; all wrong actions are equally wrong and it makes no sense to speak of one as being “worse” than another.



2.13 “delving into . . .”: A line from the lyric poet Pindar (frg. 282), quoted also by Plato, Theaetetus 173e.



3. In Carnuntum: Transmitted at the end of Book 2, but probably meant to head Book 3. Carnuntum was a fortress on the Danube which housed the Legio XIV Gemina and served as the seat of the governor of Upper Pannonia. Marcus is known to have been in the area in 172 and 173.
...
Democritus: Apparently an error for another pre-Socratic philosopher, Pherecydes, who was said to have been eaten by worms. (Democritus’s name was often coupled with that of Heraclitus, which may explain Marcus’s slip here.)
...
3.6 as Socrates used to say: It is not clear whether Marcus is alluding to a specific passage (perhaps Plato, Phaedo 83a–b) or merely to a general impression of Socratic doctrine.



3.14 your Brief Comments: Evidently collections of anecdotes and/or quotations put together by Marcus himself for his own use, like parts of the extant Meditations.



3.15 They don’t realize . . . : The significance of this entry (particularly the last phrase) is unclear.



3.16 people who do < . . . >: It seems clear that something is missing from the text, perhaps deliberately omitted by a prudish copyist.
...
4.18 < . . . > not to be distracted: The text as transmitted includes the words “good,” “black character,” and “suspicion,” but no coherent sense can be made of them.



4.19 You’re out of step . . . : The text of this sentence is disturbed and the translation correspondingly uncertain.
...
4.30 A philosopher without clothes . . . : If the text is sound it is not easy to interpret convincingly. The rendering here (which differs from most previous versions) represents my best guess at the sense, but is far from certain.



4.33 Camillus, Caeso, Volesus, Dentatus: Heroes of the Roman Republic (see the Index of Persons). Only Camillus was well known; the others may have been purposely chosen for their obscurity.
...
4.41 “A little wisp of soul . . .”: Epictetus frg. 26 (presumably from one of the lost books of the Discourses).
...
4.48 Helike, Pompeii, Herculaneum: Helike was a Greek city destroyed by an earthquake and tidal wave in 373 B.C. Pompeii and its neighbor city Herculaneum were destroyed by the eruption of Mount Vesuvius in A.D. 79.



4.49a It’s unfortunate: It has been plausibly suggested that this entry is a quotation from a lost section of Epictetus’s Discourses.



4.50 Caedicianus, Fabius, Julian, Lepidus: With the possible exception of Caedicianus and Lepidus (see the Index of Persons), none of these figures can be identified.



5.8 “the doctor”: Literally, “Asclepius.” Patients sleeping in his temple sometimes had dream visions of the god and received suggestions for treatment from him. But the name might simply indicate a human physician.



5.10 a pervert: The Greek word (used also in 6.34) is a contemptuous term referring to the passive partner in homosexual intercourse; it has no exact English equivalent (“pervert,” although overly broad, at least has the right tone). Marcus is probably using it as a generalized term of abuse.



5.12 “so many goods . . .”: Proverbial: the rich man owns “so many goods he has no place to shit.” The saying is at least as old as the fourth-century B.C. comic poet Menander, who quotes it in the surviving fragments of his play The Apparition.



5.29 If the smoke makes me cough: The metaphor is drawn from Epictetus, Discourses 1.25.18.
...
5.36 Not to be overwhelmed: The remainder of this book is unintelligible in places, perhaps because the end of the original papyrus roll suffered accidental damage. I have divided the text into three separate sections, but without great confidence that this is correct.
...
6.30 Take Antoninus as your model: The sketch that follows seems to be a preliminary version of the longer portrait at 1.16.
...
the bad line in the play: Chrysippus frg. 1181 (= Plutarch, On Stoic Self-Contradictions 13f.). Chrysippus compared the existence of evil to a deliberately bathetic line in a comedy—bad in itself, but an essential part of a good play.
...
7.15 Like gold or emerald or purple: Compare Epictetus, Discourses 1.2.17–18: “You see yourself as one thread in a garment . . . But I want to be the purple thread, the small, glistening one that enhances the others.”



7.24 “ . . . “ or in the end is put out: I have omitted a short phrase from which it is impossible to extract any meaning.



7.31a “. . . all are relative . . .”: A paraphrase of Democritus frg. B 9, in which qualities like sweetness or bitterness are said to be “relative” or “conventional” rather than inherent (what tastes sweet to one person may be bitter to another). Marcus apparently sees the observation as compatible with the Stoic doctrine that “it’s all in how you perceive it” (12.8), though he naturally rejects the subsequent reference to atoms. The final phrase is corrupt beyond repair.



7.32 [On death]: The headings of this and the next two entries are probably not Marcus’s own, but additions by a later reader.
...
7.38 “And why should we feel anger . . .”: Euripides, frg. 287 (from the lost Bellerophon quoted also at 11.6).
...
7.41 “If I and my two children . . .”: Euripides, frg. 208 (from the lost Antiope; quoted also at 11.6).
...
7.43 No chorus of lamentation: This might be a quotation, like the preceding entries, but if so, we do not know its source.
...
7.48 [Plato has it right]: The passage that follows does not correspond to anything in Plato’s preserved writings, and it seems likely that the phrase was inserted by a later reader who mistook it for a quotation.
...
7.63 “Against our will . . .”: Epictetus, Discourses 1.28.4 (also 2.22.37), paraphrasing Plato, Sophist 228c.
...
7.66 by spending the night out in the cold: This anecdote is told by Alcibiades in Plato’s Symposium (220).



the man from Salamis: During the brief reign of the “Thirty Tyrants” at Athens, Socrates was ordered to collaborate with the regime by arresting a certain Leon, but refused; the story is told in Plato’s Apology (32c).



“swaggered about the streets”: A line from Aristophanes’ comedy Clouds (362), which pokes fun at Socrates.
...
8.57 Its beams get their name . . . : This (false) derivation is a typical example of ancient etymology, a science in which the early Stoics were much interested.



9.2 the “next best voyage”: A proverbial phrase meaning having to row when one cannot sail.



9.24 “Odysseus in the Underworld”: The reference is to Book 11 of the Odyssey, in which Odysseus descends to Hades and encounters the shades of his companions who died at Troy.



9.29 Demetrius of Phalerum: It has been suggested that “of Phalerum” is a later reader’s (mistaken) addition, and that Marcus had in mind the Hellenistic monarch Demetrius Poliorcetes (“the city-sacker”). But there seems no reason to doubt the transmitted text.
...
10.23 “fencing a sheepfold . . .”: A paraphrase of Plato, Theaetetus 174d, in which we are told that the philosopher will look down on a king as if the latter were a humble shepherd.



10.31 When you look . . . : Most of the names mentioned here are mere ciphers (see the Index of Persons for the best guess as to their identities), but Marcus’s point does not depend on knowledge of the individuals.
...
11.3 [like the Christians]: This ungrammatical phrase is almost certainly a marginal comment by a later reader; there is no reason to think Marcus had the Christians in mind here. (See Introduction.)



11.6 “o Mount Cithaeron!”: Sophocles, Oedipus the King 1391 (Oedipus’s anguished cry after blinding himself, invoking the mountain he was abandoned on as a baby.)
...
11.23 “the monsters under the bed”: Plato, Crito 46c and Phaedo 77e; Marcus is probably drawing on Epictetus, Discourses 2.1.14.



11.25 Perdiccas’s invitation: In fact the ruler who invited Socrates to his court was Perdiccas’s successor Archelaus (resigned 413–399).
...
11.30 “For you/Are but a slave . . .”: From a lost tragedy. Marcus twists what must have been the sense of the original (“it is not for you to speak”) by taking logos in its broader, philosophical sense.
